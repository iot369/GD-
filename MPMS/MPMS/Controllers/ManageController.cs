...
namespace MPMS.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> EnableTwoFactorAuthentication()
        {
            ...
            return RedirectToAction("ShopManage", "Manage");
        }
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return RedirectToAction("ShopManage", new { Message = ManageMessageId.AddPhoneSuccess });
            }
        ...
        public async Task<ActionResult> RemovePhoneNumber()
        {
            ...
            if (!result.Succeeded)
            {
                return RedirectToAction("ShopManage", new { Message = ManageMessageId.Error });
            }
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            if (user != null)
            {
            ...
            return RedirectToAction("ShopManage", new { Message = ManageMessageId.RemovePhoneSuccess });
        }
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return RedirectToAction("ShopManage", new { Message = ManageMessageId.ChangePasswordSuccess });
            }
            AddErrors(result);
            return View(model);
        }
